...
CREATE
    ...
    AS
(SELECT CONCAT(customer_details.customer_gname, ' ', customer_details.customer_surname, ' ',customer_details.customer_suffix) AS Customers, customer.customer_id,credit_payment.trans_date, credit_payment.invoice, CONCAT(brand.brand_name, ' | ', item.item_desc, ' | ', item.item_add_desc) AS Description, 
...
(SELECT CONCAT(customer_details.customer_gname, ' ', customer_details.customer_surname, ' ',customer_details.customer_suffix) AS Customers, customer.customer_id,credit_payment.trans_date, credit_payment.invoice, service.service_desc AS Description, 
