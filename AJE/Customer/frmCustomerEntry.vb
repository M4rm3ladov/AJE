Public Class frmCustomerEntry
    ...
    Panel1.MouseMove, Label1.MouseDown ' Add more handles here (Example: PictureBox1.MouseMove)
    ...
    Panel1.MouseUp, Label1.MouseDown ' Add more handles here (Example: PictureBox1.MouseUp)
