...
SELECT void.trans_date, invoice , CONCAT(brand.brand_name,' | ',item.item_desc,' | ',item.item_add_desc) AS Description, category.category_name AS Category, unit.unit_name AS Unit, order_item_dtls.qty, order_item_dtls.price, order_item_dtls.line_total
...
SELECT void.trans_date, invoice, service_desc AS Description, '' AS Category ,'' AS Unit, order_svc_dtls.qty, order_svc_dtls.price, order_svc_dtls.line_total
