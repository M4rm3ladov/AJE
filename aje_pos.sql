...
MySQL - 10.4.17-MariaDB-log : Database - aje_pos
*********************************************************************
*/
...
(1,2,2,'2022-05-24',100.00,'2222222');
...
insert  into `cashier`(`cashier_id`,`user_id`,`username`,`password`,`salt`,`is_active`,`is_logged_in`) values 
(1,2,'Juan123','UD6h5i3l7/3xQt/LVq4kOQkXy/zumMCFReEtkAwvp/U=','d3qW/WeKGsiCUiARyx1lcWk3MWe1q8wEfGONzahDxaU=',1,0),
(2,3,'Pedro123','GMrjd8Y6Zj6lSobsEdxHlTXK0QKwsG8lucwO1t/jWhY=','vmdz3trzwmRova0hkwyssiDLWQz3JwZpOhZ/JQ4ZnWg=',1,0);
...
insert  into `cashier_log`(`cashier_log_id`,`cashier_id`,`manager_id`,`log_date`,`time_from`,`time_to`,`begin_bal`,`end_bal`) values 
(1,2,1,'2022-05-24','18:57:53','19:02:35',3000.00,3050.00),
(2,2,1,'2022-05-24','19:13:16','19:17:43',3050.00,3180.00),
(3,2,1,'2022-05-24','19:21:55','19:22:02',3180.00,3310.00);
...
insert  into `credit_payment`(`credit_pay_id`,`order_id`,`cashier_id`,`customer_id`,`trans_date`,`pay_amount`,`invoice`) values 
(1,1,2,1,'2022-05-24',50.00,'11111111');
...
insert  into `customer`(`customer_id`,`customer_code`,`credit_limit`,`balance`) values 
(1,'cust-0001',10000.00,20.00),
(2,'cust-0002',8000.00,0.00);
...
insert  into `customer_details`(`customer_id`,`customer_surname`,`customer_gname`,`customer_mi`,`customer_suffix`) values 
(1,'Strange','Stephen','',''),
(2,'Parker','Peter','','');
...
insert  into `inventory`(`inventory_id`,`item_id`,`branch_id`,`qty`) values 
(1,1,1,18),
(2,2,1,16),
(3,1,2,2);
...
insert  into `inventory_period`(`inv_period_id`,`period_from`,`period_to`) values 
(1,'2022-05-25','2022-05-24');
...
insert  into `item`(`item_id`,`item_code`,`item_desc`,`item_add_desc`,`brand_id`,`category_id`,`unit_id`,`item_unit_price`,`item_price_A`,`item_price_B`) values 
(1,'item-0001','Coke','Original',1,4,1,13.00,15.00,15.00),
(2,'item-0002','Orange','Original',2,4,2,35.00,40.00,38.50);
...
insert  into `manager`(`manager_id`,`user_id`,`username`,`password`,`salt`,`is_active`,`is_logged_in`) values 
(1,2,'Juan123','T/RpPxvUz9I+Ca2FVL6AFu6mECNHmJ+DuC9bf4cjrA4=','/s63lUK9YOQHC7r6UtFN2RTnp4zb//12dOaTa8VOqFE=',1,0);
...
insert  into `misc`(`critical_stock`,`credit_limit`,`misc_id`) values 
(10,10000.00,1);
...
insert  into `order_item_dtls`(`order_item_id`,`order_id`,`inventory_id`,`qty`,`price`,`line_total`) values 
(1,2,2,2,40.00,80.00);
...
insert  into `order_svc_dtls`(`order_svc_dtls`,`order_id`,`service_id`,`qty`,`price`,`line_total`) values 
(1,1,2,1,70.00,70.00);
...
insert  into `orders`(`order_id`,`trans_date`,`gross_amount`,`trans_code`,`branch_id`) values 
(1,'2022-05-24',70.00,1,1),
(2,'2022-05-24',80.00,2,1);
...
insert  into `physical_count`(`phys_count_id`,`inv_period_id`,`inventory_id`,`qty`,`count_date`,`ref_no`,`remarks`) values 
(1,1,1,10,'2022-05-24',1,'this is the real life this is a fantasy stuck in the last life no escape from reality');
...
insert  into `service`(`service_id`,`service_code`,`service_desc`,`service_fee_A`,`service_fee_B`) values 
(1,'srvc-0001','Tire Change',150.00,140.00),
(2,'srvc-0002','Oil Change',70.00,50.00);
...
insert  into `stock_in`(`stock_in_id`,`inventory_id`,`branch_id`,`supplier_id`,`ref_no`,`qty`,`trans_date`,`remarks`) values 
(1,1,1,1,1,10,'2022-05-24','initial stock in'),
(2,2,1,1,1,10,'2022-05-24','initial stock in'),
(3,1,1,2,2,10,'2022-05-24','lorem ipsum dolor sit amet mi amio ga duka'),
(4,2,1,2,2,10,'2022-05-24','lorem ipsum dolor sit amet mi amio ga duka'),
(5,1,1,2,3,2,'2022-05-23','');
...
insert  into `stock_out`(`stock_out_id`,`inventory_id`,`branch_id`,`ref_no`,`qty`,`trans_date`,`remarks`) values 
(1,1,1,1,2,'2022-05-24','I have a question to the world not an answer to be heard');
...
insert  into `stock_return`(`stock_ret_id`,`inventory_id`,`branch_id`,`supplier_id`,`ref_no`,`qty`,`trans_date`,`remarks`) values 
(1,2,1,2,1,2,'2022-05-24','One punch man is great');
...
insert  into `stock_transfer`(`stock_trans_id`,`inventory_id`,`branch_id_from`,`branch_id_to`,`ref_no`,`qty`,`trans_date`,`remarks`) values 
(1,1,1,2,1,2,'2022-05-24','langit lupa impyerno im-im impyerno');
...
insert  into `user_details`(`user_id`,`user_surname`,`user_gname`,`user_mi`,`user_suffix`) values 
(1,'Antonio','Ren','',''),
(2,'Tamad','Juan','',''),
(3,'Hampaslupa','Pedro','','');
...
insert  into `users`(`user_id`,`branch_id`,`username`,`password`,`salt`,`user_type`,`is_active`,`is_logged_in`) values 
(1,1,'admin','N24WUCv2Sz17s/UOHVG7KZlSIlACGcAVlo/euwlxz4g=','SxqrSevNPv/CVkjWfsoAGkuy3uA74UY0TKskZb9cVRE=','Admin',1,0),
(2,1,'Juan','5sFm6B5fgT5WrlL1ID8XkJ+LgZWPH5g9vrjJz0c82Vc=','NBGrMpJmVwO3+abAGk0AIm4blIfXgP/dog5biNWtqOE=','Manager',1,0),
(3,1,'Pedro','GMviqJ5L76BtAjlYqm3PRhyfYXVb7O4MBKXgiIpUglw=','xdjfiyRcTvfRH7+2CR7HOgdWs0ank/T7usg8Z+l3nrk=','Cashier',1,0);
